...
class JobExtractor:
    ...
    def search_jobs(
        self, keywords: str, location: str, num_jobs: int = 25
    ) -> List[Dict]:
        """
            ...
            for job_result in search_results:
                try:
                    ...
                    job_id = (
                        ...
                        or job_result.get("trackingUrn").split(":")[-1]
                    )
        ...
        try:
            ...
            if "linkedin.com" in job_id_or_url.lower():
                ...
                if "/jobs/view/" in job_id_or_url:
                    job_id = (
                        job_id_or_url.split("/jobs/view/")[1]
                        .split("/")[0]
                        .split("?")[0]
                    )
                    return job_id
...
if __name__ == "__main__":
    ...
    job = extractor.extract_job_details(
        "https://www.linkedin.com/jobs/collections/hiring-in-network/?currentJobId=4098985472&discover=top-applicant%2Chiring-in-network&discoveryOrigin=JOBS_HOME_COMPETITIVE_ADVANTAGE_JOB_COLLECTIONS"
    )
    print(job)
