...
class Resume(BaseModel):
    ...
    def is_latex_format(self) -> bool:
        ...
        return isinstance(self.personal_information, str) and \
               isinstance(self.skills, str) and \
               isinstance(self.work_experience, str)

    def is_structured_format(self) -> bool:
        """Check if the resume content is in structured format"""
        return isinstance(self.personal_information, dict) and \
               isinstance(self.skills, dict) and \
               isinstance(self.work_experience, list)
