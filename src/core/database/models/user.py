...
class UserPreferences(BaseModel):
    ...
    work_experience_details: WorkExperienceDetails = Field(
        default_factory=WorkExperienceDetails
    )
    skills_details: SkillsDetails = Field(default_factory=SkillsDetails)
    career_summary_details: CareerSummaryDetails = Field(
        default_factory=CareerSummaryDetails
    )
    ...
    publications_details: PublicationsDetails = Field(
        default_factory=PublicationsDetails
    )
