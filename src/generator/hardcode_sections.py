...
class HardcodeSections:
    ...
    def hardcode_section(self, section: str) -> str:
        ...
        try:
            ...
            if content:
                ...
                logger.warning(
                    f"Hardcode method returned empty content for section {section}"
                )
                return ""
        except Exception as e:
            logger.error(
                f"Error in hardcode method for section {section}: {str(e)}",
                exc_info=True,
            )
            raise
    ...
    def hardcode_personal_information(self) -> str:
        ...
        try:
            ...
            content = self.tex_loader.safe_format_template(
                "personal_information", escape_latex=False, **template_info
            )
    ...
    def hardcode_career_summary(self) -> str:
        ...
        try:
            job_title = self.portfolio.career_summary.get(
            ...
            content = self.tex_loader.safe_format_template(
                ...
                years_of_experience=str(
                    self.portfolio.career_summary.get("years_of_experience", "")
                ),
                summary=LatexEscaper.escape_text(
                    self.portfolio.career_summary.get("default_summary", "")
                ),
            )
    ...
    def hardcode_skills(self) -> str:
        ...
        try:
            ...
            content = self.tex_loader.safe_format_template(
                "skills", skills_content=skills_content
            )
    ...
    def hardcode_awards(self) -> str:
        ...
        for award in self.portfolio.awards:
            ...
            awards_content += self.tex_loader.safe_format_template(
                "award_item", **award_data
            )
        return self.tex_loader.safe_format_template(
            "awards", awards_content=awards_content
        )
    ...
    def hardcode_publications(self) -> str:
        ...
        for pub in self.portfolio.publications:
            ...
            publications_content += self.tex_loader.safe_format_template(
                "publication_item", **pub_data
            )
        return self.tex_loader.safe_format_template(
            "publications", publications_content=publications_content
        )
