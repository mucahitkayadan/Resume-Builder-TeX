...
class LLMRunner:
    ...
    def create_company_name_and_job_title(
        self, naming_prompt: str, job_description: str
    ) -> Tuple[str, str]:
        return get_company_name_and_job_title(
            self.strategy.create_folder_name(naming_prompt, job_description)
        )
